...
- **Ses / parlaklık:** Seviye değişince çentik yana doğru genişler ve tek satırda simge, ad, renkli çubuk ve değer gösterir (ses beyaz, parlaklık kehribar, şarj yeşil). macOS'un kendi göstergeleri de görünebilir.
...
- **Ayarlar:** Üzerine gelince açılma, pano kaydı, ekran seçimi (Fareyi izle / Çentikli ekran) ve çentiksiz ekran biçimi (Menü çubuğu / Ada).
...
- Pil: IOKit; ses: CoreAudio. Giriş izleme, ekran kaydı veya Erişilebilirlik izni istemez.
